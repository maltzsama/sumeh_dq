...
The best way to send feedback is to file an issue at https://github.com/maltzsama/sumeh_dq/issues.
...
Ready to contribute? Here's how to set up `sumeh_dq` for local development.

1. Fork the `sumeh_dq` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/maltzsama/sumeh_dq/pull_requests
